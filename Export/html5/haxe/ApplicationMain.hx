...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("thorn", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("thorn", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "thorn";
		app.meta["name"] = "Thorn SWF";
		app.meta["packageName"] = "bristol.gamejam.thorn";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("thorn.Main")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess thorn.Main.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"thorn.Main\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"thorn.Main\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends thorn.Main {}
#else
class DocumentClass
{
